...
import GovPilotAddressForm from './gpaddress/GovPilotAddress.form';
...
import PictureForm from './picture/Picture.form';
import FormForm from './form/Form.form';
import HiddenForm from './hidden/Hidden.form';
import HtmlElementForm from './html/HTML.form';
import LabelElementForm from './gplabel/Label.form';
import LineElementForm from './gpline/Line.form';
import MeasureElementForm from './gpmeasure/Measure.form';
...
import SchedulerForm from './gpscheduler/Scheduler.form';
import SelectboxesForm from './selectboxes/SelectBoxes.form';
import SelectForm from './select/Select.form';
import SerialNumberForm from './serialnumber/SerialNumber.form';
...
Components.gpaddress.editForm = GovPilotAddressForm;
...
Components.picture.editForm = PictureForm;
Components.form.editForm = FormForm;
Components.hidden.editForm = HiddenForm;
Components.htmlelement.editForm = HtmlElementForm;
Components.gplabel.editForm = LabelElementForm;
Components.gpline.editForm = LineElementForm;
Components.gpmeasure.editForm = MeasureElementForm;
...
Components.scheduler.editForm = SchedulerForm;
Components.select.editForm = SelectForm;
Components.selectboxes.editForm = SelectboxesForm;
Components.serialnumber.editForm = SerialNumberForm;
