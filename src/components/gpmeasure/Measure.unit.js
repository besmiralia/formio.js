...
describe('Measure Component', () => {
  it('Should create a new Measure', () => {
    const textField = new MeasureComponent({
      label: 'First Name',
      key: 'firstName',
      input: true,
      type: 'textfield'
  ...
  it('Should build a Measure component', () => {
    return Harness.testCreate(MeasureComponent, comp1).then((component) => {
      Harness.testElements(component, 'input[type="text"]', 1);
    });
  });

  it('Should disable multiple mask selector if component is disabled', (done) => {
    Harness.testCreate(MeasureComponent, comp4).then((component) => {
  ...
  it('Should provide required validation', () => {
    return Harness.testCreate(MeasureComponent, _.merge({}, comp2, {
  ...
  it('Should correctly calculate remaining words', (done) => {
    Harness.testCreate(MeasureComponent, comp5).then((component) => {
