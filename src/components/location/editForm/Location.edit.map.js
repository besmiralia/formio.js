export default [
  {
    ...
    key: 'height',
    label: 'Height',
    tooltip: 'The height of the map component in px',
    placeholder: 'The height of the map component in px',
    defaultValue: 400,
    weight: 0
  },
  {
    ...
    input: true,
    key: 'disableMarker',
    label: 'Disable moving the marker',
    tooltip: 'Check if you would like to disable the marker from moving',
    weight: 5
  },/*
  {
    type: 'textfield',
